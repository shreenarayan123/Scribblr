    ...
    return (
        <div className="flex  flex-col  items-center justify-center  relative gap-5 bg-red-100 w-full  h-full  ">
            <div className="md:flex flex-row absolute top-0 right-0 sm:hidden items-center gap-5 ">
                ...
                <span className="bg-gray-300 relative bottom-2 cursor-pointer p-3 rounded-3xl text-sm flex font-medium">mental health</span>
                </div>
           ...
           <Link to={"/signup"}><button type="button" className="text-white py-2.5 bg-green-600 hover:bg-white hover:text-green-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-lg px-8   mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Started Reading</button></Link>
           </div>
           <div className="md:flex flex-row absolute sm:hidden bottom-0 right-0 items-center gap-5 ">
                ...
                <span className="bg-gray-300 relative bottom-2 cursor-pointer p-3 rounded-3xl text-sm flex font-medium">bussiness</span>
                </div>
            ...
            <div className="md:flex flex-row absolute sm:hidden bottom-1/2 left-0 items-center gap-5 ">
                ...
                <div className="flex itmes-center justify-center gap-5">
                <span className="bg-gray-300 cursor-pointer relative bottom-2 p-3 rounded-3xl text-sm flex font-medium">Ai</span>
